...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2025 at 06:59 AM
...
--
CREATE DATABASE IF NOT EXISTS `employee list` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `employee list`;
...
CREATE TABLE `employees` (
  ...
  `Employee Name` varchar(99) NOT NULL,
  `Employee ID` int(10) NOT NULL,
  `Deprtment` varchar(99) NOT NULL,
  `Reporting Manager` varchar(99) NOT NULL
...
INSERT INTO `employees` (`SR NO`, `Employee Name`, `Employee ID`, `Deprtment`, `Reporting Manager`) VALUES
(1, 'ABCD', 12345678, 'TESTING', 'XYZ');
--
-- Database: `employees`
--
...
(3, 'employee1', 'employee123', 'employee');
...
('root', '[{\"db\":\"employee list\",\"table\":\"employees\"},{\"db\":\"employee list\",\"table\":\"Employees\"}]');
...
('root', '2025-02-27 05:35:04', '{\"Console\\/Mode\":\"collapse\"}');
